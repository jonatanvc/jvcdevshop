...
def register_admin_handlers(app: Client):
    ...
    async def cb_admin_margin_menu(client: Client, callback: CallbackQuery):
        ...
        text = (
            ...
            f"<i>La Estrategia Escalonada Progresiva multiplica los costos de la API garantizando rentabilidad incluso con Plan VIP:</i>\n"
            f"• Costo &lt; $0.50: <code>x3.5 (+250% | VIP: +180%)</code>\n"
            f"• Costo $0.50 - $0.99: <code>x2.4 (+140% | VIP: +92%)</code>\n"
            f"• Costo $1.00 - $2.99: <code>x1.75 (+75% | VIP: +40%)</code>\n"
            f"• Costo $3.00 - $7.99: <code>x1.50 (+50% | VIP: +20%)</code>\n"
            f"• Costo &ge; $8.00: <code>x1.38 (+38% | VIP: +10.4%)</code>\n\n"

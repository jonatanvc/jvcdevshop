...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "btn_wallet_transactions": "📜 Movimientos",
        ...
        "product_note_label": "Nota del Producto",
        ...
        "vip_confirm_title": (
            "👑 <b>CONFIRMAR COMPRA - PLAN REVENDEDOR VIP</b>\n\n"
            "¿Deseas activar tu <b>Membresía Revendedor VIP</b> por <b>30 días</b>?\n\n"
            "💵 <b>Costo del Plan:</b> <code>10.00 USDT</code>\n"
            "⏳ <b>Duración:</b> <code>30 días</code>\n"
            "💳 <b>Tu Saldo Actual:</b> <code>${balance} USDT</code>\n\n"
            "<i>Al confirmar, se debitarán 10.00 USDT de tu saldo del bot y se activará inmediatamente tu tarifa del 20% OFF.</i>"
        ),
        "vip_info_title": (
            ...
            "🛡️ <b>Atención Prioritaria:</b> Soporte y garantías rápidas.\n\n"
            "💵 <b>Inversión:</b> <code>10.00 USDT</code> / 30 días\n"
            "<i>(¡La mitad de lo que cobra la competencia por los mismos beneficios!)</i>"
        ),
        "vip_active_title": (
            "👑 <b>TU MEMBRESÍA VIP ESTÁ ACTIVA</b>\n\n"
            "Disfrutas de todas las ventajas y el <b>20% OFF</b> en todo el catálogo.\n\n"
            "📅 <b>Vence el:</b> <code>{expires_at}</code>\n"
            "⏳ <b>Tiempo restante:</b> <code>{days_left} días</code>\n\n"
            "<i>Puedes renovar con anticipación en cualquier momento para extender tu período 30 días más.</i>"
        ),
        "vip_success_activated": (
            "🎉 <b>¡BIENVENIDO AL PLAN REVENDEDOR VIP!</b>\n\n"
            ...
            "📅 <b>Válido hasta:</b> <code>{expires_at}</code>"
        ),
        "vip_insufficient_funds": (
            "⚠️ <b>SALDO INSUFICIENTE</b>\n\n"
            "Para activar el Plan VIP necesitas <b>10.00 USDT</b> en tu saldo del bot.\n"
            "Tu saldo actual es de: <code>${balance} USDT</code>.\n\n"
            "<i>Por favor recarga tu saldo para continuar.</i>"
        ),
        "vip_warn_24h_msg": (
            "⚠️ <b>¡TU MEMBRESÍA VIP VENCE EN 24 HORAS!</b> ⚠️\n\n"
            "Te recordamos que a tu Plan Revendedor VIP le quedan menos de <b>24 horas</b> de vigencia (Vence: <code>{expires_at}</code>).\n\n"
            "Renueva ahora para no perder tu <b>20% de descuento</b> ni tus beneficios exclusivos."
        ),
        "vip_warn_2h_msg": (
            "🚨 <b>¡URGENTE: TU MEMBRESÍA VIP VENCE EN 2 HORAS!</b> 🚨\n\n"
            "Tu Plan Revendedor VIP vencerá hoy a las <code>{expires_at}</code>.\n\n"
            "<i>Renueva tu suscripción inmediatamente para mantener tus tarifas preferenciales de distribuidor.</i>"
        ),
        "vip_expired_msg": (
            "❌ <b>TU MEMBRESÍA VIP HA FINALIZADO</b>\n\n"
            "Tu período de 30 días ha concluido y tu cuenta ha regresado al estado Regular.\n\n"
            "<i>Puedes reactivar tu membresía VIP en cualquier momento por 10 USDT para volver a disfrutar del 20% OFF.</i>"
        ),
        "vip_admin_granted_msg": (
            "👑 <b>¡MEMBRESÍA VIP OTORGADA POR ADMINISTRADOR!</b>\n\n"
            "Un administrador te ha otorgado acceso al <b>Plan Revendedor VIP</b> por <b>{days} días</b>.\n\n"
            "📅 <b>Vigente hasta:</b> <code>{expires_at}</code>\n\n"
            "<i>¡Aprovecha tu 20% de descuento en todo el catálogo!</i>"
        ),
        "vip_client_template": (
            "✨ <b>Tu Servicio Digital</b> ✨\n\n"
    ...
    "en": {
        ...
        "btn_wallet_transactions": "📜 Transactions",
        ...
        "product_note_label": "Product Note",
        ...
        "vip_confirm_title": (
            "👑 <b>CONFIRM PURCHASE - VIP RESELLER PLAN</b>\n\n"
            "Do you want to activate your <b>VIP Reseller Membership</b> for <b>30 days</b>?\n\n"
            "💵 <b>Plan Cost:</b> <code>10.00 USDT</code>\n"
            "⏳ <b>Duration:</b> <code>30 days</code>\n"
            "💳 <b>Your Current Balance:</b> <code>${balance} USDT</code>\n\n"
            "<i>Upon confirmation, 10.00 USDT will be deducted from your bot balance and your 20% OFF rates will be activated immediately.</i>"
        ),
        "vip_info_title": (
            ...
            "🛡️ <b>Priority Support:</b> Fast warranty resolutions.\n\n"
            "💵 <b>Price:</b> <code>10.00 USDT</code> / 30 days\n"
            "<i>(Half of what competitors charge for identical perks!)</i>"
        ),
        "vip_active_title": (
            "👑 <b>YOUR VIP MEMBERSHIP IS ACTIVE</b>\n\n"
            "You enjoy all exclusive benefits and <b>20% OFF</b> catalog-wide.\n\n"
            "📅 <b>Expires on:</b> <code>{expires_at}</code>\n"
            "⏳ <b>Days left:</b> <code>{days_left} days</code>\n\n"
            "<i>You can renew anytime to extend your plan by another 30 days.</i>"
        ),
        "vip_success_activated": (
            "🎉 <b>WELCOME TO THE VIP RESELLER PLAN!</b>\n\n"
            ...
            "📅 <b>Valid until:</b> <code>{expires_at}</code>"
        ),
        "vip_insufficient_funds": (
            "⚠️ <b>INSUFFICIENT BALANCE</b>\n\n"
            "To activate the VIP Plan you need <b>10.00 USDT</b> in your bot balance.\n"
            "Your current balance is: <code>${balance} USDT</code>.\n\n"
            "<i>Please top up your balance to proceed.</i>"
        ),
        "vip_warn_24h_msg": (
            "⚠️ <b>YOUR VIP MEMBERSHIP EXPIRES IN 24 HOURS!</b> ⚠️\n\n"
            "Your VIP Reseller Plan expires in less than <b>24 hours</b> (Expires: <code>{expires_at}</code>).\n\n"
            "Renew now to keep your <b>20% discount</b> and perks active."
        ),
        "vip_warn_2h_msg": (
            "🚨 <b>URGENT: YOUR VIP MEMBERSHIP EXPIRES IN 2 HOURS!</b> 🚨\n\n"
            "Your VIP Reseller Plan expires today at <code>{expires_at}</code>.\n\n"
            "<i>Renew immediately to maintain your wholesale pricing.</i>"
        ),
        "vip_expired_msg": (
            "❌ <b>YOUR VIP MEMBERSHIP HAS EXPIRED</b>\n\n"
            "Your 30-day period ended and your account reverted to Regular status.\n\n"
            "<i>You can reactivate anytime for 10 USDT to restore your 20% OFF.</i>"
        ),
        "vip_admin_granted_msg": (
            "👑 <b>VIP MEMBERSHIP GRANTED BY ADMIN!</b>\n\n"
            "An administrator has granted you <b>VIP Reseller</b> access for <b>{days} days</b>.\n\n"
            "📅 <b>Valid until:</b> <code>{expires_at}</code>\n\n"
            "<i>Enjoy your 20% discount on all digital services!</i>"
        ),
        "vip_client_template": (
            "✨ <b>Your Digital Service</b> ✨\n\n"
            "📦 <b>Product:</b> {product}\n"
            "🔑 <b>Login Details:</b>\n<pre>{items}</pre>"
            "{warranty_text}"
            "{after_note}\n\n"
    ...
    "pt": {
        ...
        "btn_wallet_transactions": "📜 Extrato",
        "btn_referrals": "🔗 Referidos",
        ...
        "btn_view_note": "📝 Ver Nota",
        "product_note_label": "Nota do Produto",
        ...
        "vip_status_active": "⭐ Revendedor VIP",
        "vip_confirm_title": (
            "👑 <b>CONFIRMAR COMPRA - PLANO REVENDEDOR VIP</b>\n\n"
            "Deseja ativar sua <b>Assinatura Revendedor VIP</b> por <b>30 dias</b>?\n\n"
            "💵 <b>Valor do Plano:</b> <code>10.00 USDT</code>\n"
            "⏳ <b>Duração:</b> <code>30 dias</code>\n"
            "💳 <b>Seu Saldo Atual:</b> <code>${balance} USDT</code>\n\n"
            "<i>Ao confirmar, 10.00 USDT serão debitados do seu saldo do bot e suas tarifas de 20% OFF serão ativadas imediatamente.</i>"
        ),
        "vip_info_title": (
            ...
            "🛡️ <b>Suporte Prioritário:</b> Atendimento ágil e garantia rápida.\n\n"
            "💵 <b>Investimento:</b> <code>10.00 USDT</code> / 30 dias\n"
            "<i>(Metade do preço cobrado pelos concorrentes pelos mesmos benefícios!)</i>"
        ),
        "vip_active_title": (
            "👑 <b>SUA ASSINATURA VIP ESTÁ ATIVA</b>\n\n"
            "Você aproveita todas as vantagens e <b>20% OFF</b> em todo o catálogo.\n\n"
            "📅 <b>Expira em:</b> <code>{expires_at}</code>\n"
            "⏳ <b>Dias restantes:</b> <code>{days_left} dias</code>\n\n"
            "<i>Você pode renovar a qualquer momento para estender por mais 30 dias.</i>"
        ),
        "vip_success_activated": (
            "🎉 <b>BEM-VINDO AO PLANO REVENDEDOR VIP!</b>\n\n"
            ...
            "📅 <b>Válido até:</b> <code>{expires_at}</code>"
        ),
        "vip_insufficient_funds": (
            "⚠️ <b>SALDO INSUFICIENTE</b>\n\n"
            "Para ativar o Plano VIP você precisa de <b>10.00 USDT</b> no seu saldo do bot.\n"
            "Seu saldo atual é de: <code>${balance} USDT</code>.\n\n"
            "<i>Por favor recarregue seu saldo para continuar.</i>"
        ),
        "vip_warn_24h_msg": (
            "⚠️ <b>SUA ASSINATURA VIP EXPIRA EM 24 HORAS!</b> ⚠️\n\n"
            "Lembramos que seu Plano Revendedor VIP tem menos de <b>24 horas</b> restantes (Expira: <code>{expires_at}</code>).\n\n"
            "Renove agora para não perder seus <b>20% de desconto</b> e vantagens exclusivas."
        ),
        "vip_warn_2h_msg": (
            "🚨 <b>URGENTE: SUA ASSINATURA VIP EXPIRA EM 2 HORAS!</b> 🚨\n\n"
            "Seu Plano Revendedor VIP vai expirar hoje às <code>{expires_at}</code>.\n\n"
            "<i>Renove imediatamente para manter seus preços de distribuidor.</i>"
        ),
        "vip_expired_msg": (
            "❌ <b>SUA ASSINATURA VIP TERMINOU</b>\n\n"
            "Seu período de 30 dias terminou e sua conta voltou ao status Regular.\n\n"
            "<i>Você pode reativar a qualquer momento por 10 USDT para recuperar o 20% OFF.</i>"
        ),
        "vip_admin_granted_msg": (
            "👑 <b>ASSINATURA VIP CONCEDIDA PELO ADMINISTRADOR!</b>\n\n"
            "Um administrador concedeu acesso ao <b>Plano Revendedor VIP</b> por <b>{days} dias</b>.\n\n"
            "📅 <b>Válido até:</b> <code>{expires_at}</code>\n\n"
            "<i>Aproveite seu desconto de 20% em todo o catálogo!</i>"
        ),
        "vip_client_template": (
            "✨ <b>Seu Serviço Digital</b> ✨\n\n"
            "📦 <b>Produto:</b> {product}\n"
            "🔑 <b>Dados de Acesso:</b>\n<pre>{items}</pre>"
            "{warranty_text}"
            "{after_note}\n\n"

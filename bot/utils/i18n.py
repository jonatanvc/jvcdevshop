...
from bot.utils.emojis import (
    EMOJI_STORE, EMOJI_USER, EMOJI_ID, EMOJI_MONEY, EMOJI_PROVIDER, EMOJI_SHOPPING,
    EMOJI_CART, EMOJI_CARD, EMOJI_ORDERS, EMOJI_LINK, EMOJI_SUPPORT, EMOJI_ADMIN,
    EMOJI_HOME, EMOJI_REFRESH, EMOJI_SEARCH, EMOJI_CHAT, EMOJI_WARN, EMOJI_WALLET,
    EMOJI_LANG, EMOJI_GLOBE, EMOJI_CALENDAR, EMOJI_FLAG_ES, EMOJI_FLAG_EN, EMOJI_FLAG_PT,
    EMOJI_CHECK, EMOJI_FOLDER, EMOJI_GREEN_DOT, EMOJI_GIFT, EMOJI_RED_DOT, EMOJI_CROSS,
    EMOJI_WRITE, EMOJI_BOX, EMOJI_TAG, EMOJI_SHIELD, EMOJI_LOCK, EMOJI_NOTE,
...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "catalog_header_todos": f"{EMOJI_FOLDER} <b>TODOS LOS SERVICIOS</b> ({{count}})",
    ...
    "en": {
        ...
        "catalog_header_todos": f"{EMOJI_FOLDER} <b>ALL SERVICES</b> ({{count}})",
    ...
    "pt": {
        ...
        "catalog_header_todos": f"{EMOJI_FOLDER} <b>TODOS OS SERVIÇOS</b> ({{count}})",

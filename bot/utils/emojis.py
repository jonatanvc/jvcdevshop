...
# 47- Botón Volver / Atrás - (6039539366177541657)
EMOJI_BACK = pe("6039539366177541657", "😀")
...
# 60- Botón Activar Alerta Stock - (5242628160297641831)
...
# 63- Botón Ingresar Otro Monto - (5334882760735598374)
EMOJI_WRITE = pe("5334882760735598374", "📝")

# Stepper interactivo (+ / -)
EMOJI_PLUS = pe("5305766859608440427", "➕")
EMOJI_MINUS = pe("5305765300535311154", "➖")
...
# Panel de Mantenimiento / Herramientas - (5341715473882955310)
EMOJI_TOOLS = pe("5341715473882955310", "⚙️")
